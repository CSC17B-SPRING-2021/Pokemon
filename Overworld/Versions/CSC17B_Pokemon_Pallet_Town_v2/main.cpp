 ...
 * Author: Josh
 *
 * Created on March 9, 2021, 10:17 PM
 */
...
int main() {
	...
	GetPlayer();
	// cout<<"Oak       : Right! So your name is "<< PrintPlayerInfo() << endl;
	cout << "\nAn image of another boy appears.\n";
	GetRival();
	// cout<<"Oak       : That's right! I remember now! His name is \n"<<
	// PrintRivalInfo() <<endl;
	cout << "\nPlayer's image reappears.\n";
	// cout<<"Oak       :  "<< PrintPlayerInfo() << "Your very own POKEMON
	// legend is about to unfold! A world of\n";
